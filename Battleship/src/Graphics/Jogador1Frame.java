...
public class Jogador1Frame extends JFrame {

	private static final Jogador1Frame INSTANCE = new Jogador1Frame();
	...
	private Jogador1Frame() {
		setVisible(true);
		setBounds(20, 130, 250, 500);
		setLayout(null);
	...
	public static synchronized Jogador1Frame getInstance() {
		return INSTANCE;
	}
